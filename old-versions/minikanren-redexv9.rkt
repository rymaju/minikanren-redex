...
(define red
  (reduction-relation
   ...
   [--> (Γ (in-hole E ((r t ...) σ)))
        ...
        "relation call"]
#;(((conso (f r out) ((cons f r) =? out))
    (nullo (ls) (ls =? (quote ())))
    (appendo (l t out) (((nullo l) ∧ (t =? out)) ∨ (∃ a (∃ d (∃ res ((conso a d l) ∧ ((conso a res out) ∧ (appendo d t res)))))))))
   (cons∞ ((((var 1) (cons 1 (cons 2 (cons 3 (quote ()))))) ((var 0) (quote ()))) 4)
          ((∃ res ((conso (var 4) (var 5) (var 0))
                   ∧
                   ((conso (var 4) res (cons 1 (cons 2 (cons 3 (quote ())))))
                    ∧
                    (appendo (var 5) (var 1) res)))) (() 6))))
   [--> (in-hole E ((∃ x g) σ))
...
#;(cons∞ ((((var 1) (2))
           ...
           ((var 4) 2)
           ((var 2) 1)
           ((var 0) (cons (var 2) (var 3))))
          5)
         ())

#;(unify-terms (var 1) (var 4)
               ((((var 3) (quote ()))
                 ((var 4) 2)
                 ((var 2) 1)
                 ((var 0) (cons (var 2) (var 3))))
...
(define (racket-pairs-to-cons-terms pr)
  (match pr
    [`(var ,_) pr]
    [`(,a . ,d) `(cons ,(racket-pairs-to-cons-terms a)
                       ,(racket-pairs-to-cons-terms d))]
    [else pr]))
...
(define-metafunction L
  ...
  [(unify-terms t_1 t_2 σ)
   ,(let [(s (unify (term t_1) (term t_2) (first (term σ))))]
      (if s
          ; if s is a racket list, we need to convert it into a term "t" cons list
         
              (term (cons∞ (,s ,(second (term σ))) ()))

          (term ())))])
#;(cons∞ ((((var 2) (cons 2 (quote ())))
           ((var 1) 1))
          4)
         ())
